...
@dataclass
class SdeVeGFNOutput(BaseOutput):
    """
...
class ScoreSdeVeGFNScheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def step_pred(
        ...
        Args:
            ...
            return_dict (`bool`, *optional*, defaults to `True`):
                Whether or not to return a [`~schedulers.scheduling_sde_ve.SdeVeGFNOutput`] or `tuple`.

        Returns:
            [`~schedulers.scheduling_sde_ve.SdeVeGFNOutput`] or `tuple`:
                If return_dict is `True`, [`~schedulers.scheduling_sde_ve.SdeVeGFNOutput`] is returned, otherwise a tuple
        ...
        return SdeVeGFNOutput(
            prev_sample=prev_sample,
            prev_sample_mean=prev_sample_mean,
            posterior_mean=prev_sample_mean,
            posterior_std=diffusion,
            noise=noise
        )
