...
class EDMEulerScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        posterior_sig = 0.
        if gamma > 0:
            posterior_sig = (sigma_hat**2 - sigma**2) ** 0.5
            sample += posterior_sig * eps
        ...
        posterior_mean = prev_sample - posterior_sig * eps
        ...
        return EDMEulerSchedulerOutput(
            prev_sample=prev_sample,
            pred_original_sample=pred_original_sample,
            posterior_mean=posterior_mean,
            posterior_std=posterior_sig,
            noise=eps
        )
